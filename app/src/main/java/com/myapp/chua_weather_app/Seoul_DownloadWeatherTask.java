 ...
 */
public class Seoul_DownloadWeatherTask extends AsyncTask<String, Void, String> {
    ...
    protected void onPostExecute(String s) {
        ...
        try {
            ...
            for (int i = 0; i < arr.length(); i++) {
                ...
                Home.textWeatherSeoul.setText(description);
            ...
            Home.textTemperatureSeoul.setText(String.valueOf(temperatureInt) + " °C");
            Home.textLocationSeoul.setText(place);
            Home.textPressureSeoul.setText("Pressure: "+String.valueOf(pressure));
            Home.textHumiditySeoul.setText("Humidity: "+String.valueOf(humidity));
            Home.textMinTempSeoul.setText("Min Temperature: "+String.valueOf(mintempInt)+"°C");
            Home.textMaxTempSeoul.setText("Max Temperature: "+String.valueOf(maxtempInt)+"°C");
            Home.textSpeedSeoul.setText("Speed: "+String.valueOf(speed));
            Home.textDegreeSeoul.setText("Degree: "+String.valueOf(degree));
