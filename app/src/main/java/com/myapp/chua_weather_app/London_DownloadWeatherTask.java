...
public class London_DownloadWeatherTask extends AsyncTask<String, Void, String> {
    ...
    protected String doInBackground(String... weatherURL) {
        ...
        System.out.println("WAAAAAAHH"+String.valueOf(weatherURL));
    ...
    protected void onPostExecute(String s) {
        ...
        try {
            ...
            for (int i = 0; i < arr.length(); i++) {
                ...
                Home.textWeatherLondon.setText(description);
            ...
            Home.textTemperatureLondon.setText(String.valueOf(temperatureInt) + " °C");
            Home.textLocationLondon.setText(place);
            Home.textPressureLondon.setText("Pressure: "+String.valueOf(pressure));
            Home.textHumidityLondon.setText("Humidity: "+String.valueOf(humidity));
            Home.textMinTempLondon.setText("Min Temperature: "+String.valueOf(mintempInt)+"°C");
            Home.textMaxTempLondon.setText("Max Temperature: "+String.valueOf(maxtempInt)+"°C");
            Home.textSpeedLondon.setText("Speed: "+String.valueOf(speed));
            Home.textDegreeLondon.setText("Degree: "+String.valueOf(degree));
