 ...
 */
public class Tokyo_DownloadWeatherTask extends AsyncTask<String, Void, String> {
    ...
    protected void onPostExecute(String s) {
        ...
        try {
            ...
            for (int i = 0; i < arr.length(); i++) {
                ...
                Home.textWeatherTokyo.setText(description);
            ...
            Home.textTemperatureTokyo.setText(String.valueOf(temperatureInt) + " °C");
            Home.textLocationTokyo.setText(place);
            Home.textPressureTokyo.setText("Pressure: "+String.valueOf(pressure));
            Home.textHumidityTokyo.setText("Humidity: "+String.valueOf(humidity));
            Home.textMinTempTokyo.setText("Min Temperature: "+String.valueOf(mintempInt)+"°C");
            Home.textMaxTempTokyo.setText("Max Temperature: "+String.valueOf(maxtempInt)+"°C");
            Home.textSpeedTokyo.setText("Speed: "+String.valueOf(speed));
            Home.textDegreeTokyo.setText("Degree: "+String.valueOf(degree));
