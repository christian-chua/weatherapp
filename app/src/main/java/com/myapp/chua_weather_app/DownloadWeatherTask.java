    ...
    protected void onPostExecute(String s) {
        ...
        try {
            ...
            for (int i = 0; i < arr.length(); i++) {
                ...
                Home.textWeather.setText(description);
            ...
            Home.textTemperature.setText(String.valueOf(temperatureInt) + " °C");
            Home.textLocation.setText("Current Location: "+"("+place+")");
            Home.textPressure.setText("Pressure: "+String.valueOf(pressure));
            Home.textHumidity.setText("Humidity: "+String.valueOf(humidity));
            Home.textMinTemp.setText("Min Temperature: "+String.valueOf(mintempInt)+"°C");
            Home.textMaxTemp.setText("Max Temperature: "+String.valueOf(maxtempInt)+"°C");
            Home.textSpeed.setText("Speed: "+String.valueOf(speed));
            Home.textDegree.setText("Degree: "+String.valueOf(degree));
